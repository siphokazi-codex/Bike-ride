...
public class FunRideTest {
    ...
    public void returnNumberOfBikes () {
        ...
        BicycleSpecification roadBikeSpecOne = new BicycleSpecification(11, -4, BicycleType.RoadBike);
        Bicycle roadBikeOne = new BicycleFromSpec(roadBikeSpecOne);

        BicycleSpecification roadBikeSpecTwo = new BicycleSpecification(11, -4, BicycleType.RoadBike);
        Bicycle roadBikeTwo = new BicycleFromSpec(roadBikeSpecTwo);

        BicycleSpecification mountainBikeSpecOne = new BicycleSpecification(5, -3, BicycleType.MountainBike);
        Bicycle mountainBikeOne = new BicycleFromSpec(mountainBikeSpecOne);

        BicycleSpecification mountainBikeSpecTwo = new BicycleSpecification(5, -3, BicycleType.MountainBike);
        Bicycle mountainBikeTwo = new BicycleFromSpec(mountainBikeSpecTwo);
